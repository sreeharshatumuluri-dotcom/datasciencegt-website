...
const WhoWeAre = () => {
  return (
    <div className="bg-black text-white min-h-screen pt-16">
      ...
      <div className="relative overflow-hidden hero-video-background">
        {/* Overlay for better text readability */}
        <div className="video-overlay"></div>
        
        {/* Content */}
        <div className="hero-content max-w-7xl mx-auto px-6 pt-20 pb-32">
          {/* Status Badge */}
          <div className="flex items-center space-x-2 mb-8">
            <div className="w-2 h-2 bg-green-500 rounded-full"></div>
            <span className="text-gray-400 text-sm">Since 2015 • Pittsburgh HQ • Cloud + ML + Analytics</span>
          </div>

          {/* Main Headline */}
          <div className="max-w-4xl">
            <h1 className="text-6xl font-bold leading-tight mb-8">
              End-to-end <span className="text-blue-400">data platforms</span>
              <br />
              for decisive teams
            </h1>
        ...
        <div className="max-w-7xl mx-auto px-6 py-20">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {[
              ...
              <div key={idx} className="border border-gray-800 rounded-lg p-6 hover:bg-gray-900 transition-colors cursor-pointer">
